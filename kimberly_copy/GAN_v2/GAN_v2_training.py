...
from discriminator_v2 import BurstDiscriminator
...
# 7. Save Final Models
# ------------------------
torch.save(generator.state_dict(), 'generator_final_v2.pth')
torch.save(discriminator.state_dict(), 'discriminator_final_v2.pth')
